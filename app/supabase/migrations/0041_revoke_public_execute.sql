-- Finish the job 0039 started, and fix the way it was written.
--
-- 0039 said it closed five SECURITY DEFINER functions to `anon`. It closed
...
-- the work. The three functions 0039 did close were closed by a
...
--
-- Also closes the two trigger functions added in 0040. A trigger function
