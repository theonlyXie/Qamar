...
--
-- 0042 had to correct thirty-six curated foods whose nutrients came from the
...
-- listed certainties would have missed every one of the foods 0042 fixed.
...
comment on view public.food_citation_suspects is
  ...
  'these before trusting their numbers; see migration 0042 for what happened '
  'when nobody could.';
