...
///
/// Two places offer scanning — the Log sheet and, after a barcode that found
/// nothing, the conversation — and the flow has two steps and several ways to
/// fall back, so it lives here rather than being written twice and drifting.
/// A scan is a camera use and is metered like a meal photo (the gateway's
/// photo bucket), so nothing here decides who may scan.
///
...
///
/// Used on its own from the Log sheet, and as the second step after a barcode
